...
(defmethod monster-attack ((m orc))
  (let ((x (randval (orc-club-level m))))
    (princ "An orc swings his club at you and knocks you off ")
    (princ x)
...
(defmethod monster-hit ((m hydra) x)
  (decf (monster-health m) x)
  (if (monster-dead m)
      (princ "The corpse of the fuly decapitated and decapacitated hydra falls to the floor!")
...
(defmethod monster-attacj ((m slime-mold))
